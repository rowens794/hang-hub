...
const ACTIVITIES: Activity[] = [
  {
    ...
    content: "Your parents approved the 'Park Soccer' hang! ⚽️",
    timestamp: "2 mins ago",
    isRead: false,
    meta: { hangTitle: "Park Soccer" },
  },
  {
    id: "2",
    type: "hang_joined",
    ...
    content: "Alex joined the 'Sleepover & Gaming' hang. 🎮",
    timestamp: "15 mins ago",
    isRead: false,
    meta: { hangTitle: "Sleepover & Gaming" },
  },
  {
    id: "3",
    type: "ping",
    ...
    content: "Jordan pinged you! 'You down for soccer tomorrow?'",
  ...
  },
  {
    ...
    content: "Riley suggested a new hang: 'Movie Night' 🍿",
    timestamp: "2 hours ago",
    isRead: true,
    meta: { hangTitle: "Movie Night" },
  },
  {
    id: "5",
    type: "new_friend",
    ...
    content: "You and Casey are now friends! Wave hello. 👋",
  ...
  },
  {
    ...
    content: "Sam joined the 'Sleepover & Gaming' hang. 🍕",
